...
public enum AnalogData implements CommonComplianceInfo {
  ...
  // JSDK-1638: Added InstrumentRange to all items.

  BYTE("Byte", Identifiers.Byte, UnsignedByte.valueOf(0), new Range(U.LOW, U.HIGH), new Range(U.LOW, U.HIGH)),

  BYTE_ARRAY("Byte", Identifiers.Byte, Util.unsignedByteArray(0, 1, 2, 3, 4, 5), new Range(U.LOW, U.HIGH),
      new Range(U.LOW, U.HIGH)),

  DOUBLE("Double", Identifiers.Double, Double.valueOf(0), new Range(S.LOW, S.HIGH), new Range(S.LOW, S.HIGH)),

  DOUBLE_ARRAY("Double", Identifiers.Double, Util.doubleArray(0, 1, 2, 3, 4, 5), new Range(S.LOW, S.HIGH),
      new Range(S.LOW, S.HIGH)),

  // JSDK-1638: The CTT wants to have a Double or Float Node with EURange(0,0).
  FLOAT("Float", Identifiers.Float, Float.valueOf(0), new Range(0.0, 0.0), new Range(0.0, 0.0)),
  ...
  INT16("Int16", Identifiers.Int16, Short.valueOf((short) 0), new Range(S.LOW, S.HIGH), new Range(S.LOW, S.HIGH)),

  INT16_ARRAY("Int16", Identifiers.Int16, Util.signedShortArray(0, 1, 2, 3, 4, 5), new Range(S.LOW, S.HIGH),
      new Range(S.LOW, S.HIGH)),

  // JSDK-1638: The CTT wants to have at least one Node without InstrumentRange
  ...
  INT64("Int64", Identifiers.Int64, Long.valueOf(0), new Range(S.LOW, S.HIGH), new Range(S.LOW, S.HIGH)),

  INT64_ARRAY("Int64", Identifiers.Int64, Util.signedLongArray(0, 1, 2, 3, 4, 5), new Range(S.LOW, S.HIGH),
      new Range(S.LOW, S.HIGH)),

  SBYTE("SByte", Identifiers.SByte, Byte.valueOf((byte) 0), new Range(S.LOW, S.HIGH), new Range(S.LOW, S.HIGH)),

  SBYTE_ARRAY("SByte", Identifiers.SByte, Util.signedByteArray(0, 1, 2, 3, 4, 5), new Range(S.LOW, S.HIGH),
      new Range(S.LOW, S.HIGH)),

  UINT16("UInt16", Identifiers.UInt16, UnsignedShort.valueOf(0), new Range(U.LOW, U.HIGH), new Range(U.LOW, U.HIGH)),

  UINT16_ARRAY("UInt16", Identifiers.UInt16, Util.unsignedShortArray(0, 1, 2, 3, 4, 5), new Range(U.LOW, U.HIGH),
      new Range(U.LOW, U.HIGH)),

  UINT32("UInt32", Identifiers.UInt32, UnsignedInteger.valueOf(0), new Range(U.LOW, U.HIGH), new Range(U.LOW, U.HIGH)),

  UINT32_ARRAY("UInt32", Identifiers.UInt32, Util.unsignedIntegerArray(0, 1, 2, 3, 4, 5), new Range(U.LOW, U.HIGH),
      new Range(U.LOW, U.HIGH)),

  UINT64("UInt64", Identifiers.UInt64, UnsignedLong.valueOf(0), new Range(U.LOW, U.HIGH), new Range(U.LOW, U.HIGH)),
